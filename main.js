...
///////////////////forEach///////////////////////////
  // Lightning Exercise: Add another p sibling to the current one 
...
businesses.forEach(business => {
  outEl.innerHTML += `
    ...
    <p>
    ${business.addressCity}, ${business.addressStateCode}, ${business.addressStateCode}
    </p>
  `
  outEl.innerHTML += "<hr/>"
});
...
// Lightning Exercise: Instead of just returning the purchasing agent object, return a new object 
// that has the full name of the purchasing agent, the company name, and the phone number. 
